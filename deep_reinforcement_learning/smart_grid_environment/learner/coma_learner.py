...
class COMALearner:
    def __init__(self, models, critic, params):
        self.args = params
        self.n_agents = params.get('n_actions', 3)
        ...
        self.agent_params = list(models.parameters())
        self.critic_params = list(self.critic.parameters())
        self.params = self.agent_params + self.critic_params

        self.agent_optimiser = RMSprop(params=self.agent_params, lr=params.get('lr', 5E-4))
        self.critic_optimiser = RMSprop(params=self.critic_params, lr=params.get('critic_lr', 1E-3))

    def train(self, batch, t_env: int):
    ...
    def _train_critic(self, batch, avail_actions, mask, bs, max_t):
        ...
        terminated = th.cat([batch[a]['dones'] for a in batch.keys()], dim=1)
