def default_params():
    ...
    return {  # Debugging outputs and plotting during training
            ...
            'max_episode_length': 30,         # maximum number of steps per episode
            ...
            'lr': 5E-3,                       # learning rate of optimizer
            'critic_lr': 5E-3,                # learning rate of the critic
            ...
            # DQN parameters
            'replay_buffer_size': int(5E3),   # the number of transitions in the replay buffer
